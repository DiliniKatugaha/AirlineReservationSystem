...
public class EmployeeHomePage extends JFrame implements ActionListener {
    JButton btnBookFlight, btnViewBookedFlights , btnCancelTicket, btnViewFlights,btnAddFlightJourney,btnPassengerDetailsView,btnUpdateFlightJourney,btnUpdatePassenger,btnViewFlightJourney, btnLogOut;
