...
public class SignUp extends JFrame implements ActionListener {
    ...
    SignUp() {
        ...
        L12 = new JLabel("Passport Id");
        L12.setBounds(450, 350, 200, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == bt1) {
            ...
            String passportid = tf10.getText();

            try {
                ConnectionClass obj = new ConnectionClass();
                String q = "INSERT INTO passengers (username, password, age, dob, address, contact, email, nationality, gender, passportid) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
